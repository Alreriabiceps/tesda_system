...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-base-200 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 h-full" style={{ width: '45%', backgroundImage: 'url(/bg.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom right', opacity: 0.5 }}></div>
            {/* Main Content (overlays background) */}
            <div className="relative z-10">
                {/* Hero Section */}
                <div className="hero bg-base-100 bg-opacity-80">
                    <div className="hero-content text-center py-12">
                        <div className="max-w-2xl">
                            <div className="flex justify-end mb-4">
                                <ThemeToggle />
                            </div>
                            <h1 className="text-3xl font-bold mb-4">WELCOME TO EXACT Colleges HOTEL</h1>
